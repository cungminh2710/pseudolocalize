...
const Home: NextPage = () => {
	...
	const title = formatMessage({ defaultMessage: 'Create Next App', id: '9x6Yuc' });
	const description = formatMessage({ defaultMessage: 'Generated by create next app', id: 'GypOV8' });
	return (
