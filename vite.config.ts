...
export default defineConfig({
	...
	fmt: {
		...
		ignorePatterns: ['.zed', 'migrations', 'CHANGELOG.md'],
	},
	lint: {
		plugins: ['react', 'unicorn', 'typescript', 'oxc', 'import', 'vitest', 'nextjs', 'react-perf', 'promise', 'node'],
		categories: {},
		rules: {
			'for-direction': 'warn',
		...
		globals: {},
		ignorePatterns: ['examples/**', 'vite.config.ts'],
		options: {
			typeAware: true,
			typeCheck: true,
		},
